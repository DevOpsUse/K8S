...
* **Command**: `kubectl get all` >>> list all the deployments/rs/pods/svc from `default` namespace.

**picture-1**

![image](https://user-images.githubusercontent.com/24622526/44387273-986cdb80-a514-11e8-9137-3fc57f55858a.png)

* **Command**: `kubectl get pods` or `kubectl get pod` >>> check the pod availability on the nodes.
...
* `kubectl get all` >>> list all the deployments/rs/pods/svc from `default` namespace.
